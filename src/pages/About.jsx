const About = () => {
  return (
    <>
      <article className="md:gap-8 md:grid md:grid-cols-3">
        ...
        <div className="col-span-2 mt-6 md:mt-0">
            ...
            <div className="pe-4">
              <footer>
                <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                  Updated<time>: November 27, 2023</time>
                </p>
              </footer>
              <h4 className="text-xl font-bold text-gray-900 dark:text-white">
                About Sound Systems Review Page
              </h4>
            </div>
          ...
          <p className="mb-2 text-gray-500 dark:text-gray-400">
            <p>
              On this page you will find the characteristics of the most
              relevant and newest sound devices from the most recognized brands.
            </p>

            <p>
              Our goal is to provide you with detailed and up-to-date
              information on the latest sound devices, so you can make the best
              purchasing decision.
            </p>

            <p>
              You will find information about the following aspects of sound
              devices:
            </p>

            <ul>
              <li>
                <strong>Technical characteristics</strong>: dimensions, weight,
                material, connectivity, output power, frequency response,
                battery, playback time, water and dust resistance, etc.
              </li>
              <li>
                <strong>Audio characteristics</strong>: sound quality, power,
                balance, bass, treble, etc.
              </li>
              <li>
                <strong>Additional features</strong>: design, functions,
                accessories, etc.
              </li>
            </ul>

            <p>
              You will also find reviews of the most popular sound devices, so
              you can find out what other users think.
            </p>
          </p>
          <p className="mb-5 text-gray-500 dark:text-gray-400">Thanks...</p>
      ...
      <div className="section-2" style={{ margin: "100px 0" }}></div>
